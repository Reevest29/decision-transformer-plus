...
class PreTrainer:
    ...
    def pretrain_step(self):
        ...
        for t in range(self.max_ep_len):
            ...
            exp_next_state, exp_next_reward, exp_next_done, _ = self.env.step(actions[:,-1].reshape(-1))
            dt_next_state, dt_next_reward, dt_next_done, _ = practice_env.step(action_preds[:,-1].reshape(-1))
